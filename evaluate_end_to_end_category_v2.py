"""End-to-end evaluation of Category Shazam v2 without overwriting v1 results."""
...
OUTPUT_CSV = ROOT / "outputs" / "category_shazam_v2_end_to_end.csv"
OUTPUT_JSON = ROOT / "outputs" / "category_shazam_v2_end_to_end_summary.json"
ERROR_CSV = ROOT / "outputs" / "category_shazam_v2_errors.csv"
...
def main() -> None:
    ...
    system = CategoryFingerprintV2System(output_dir=str(ROOT / "outputs_gui"))
    ...
    errors = [row for row in completed_rows if not truth(row["end_to_end_correct"])]
